...
Ctrl + 左键单击|	入光标所在的方法/变量的接口或是定义处，等同于 Ctrl + B （必备）
...
Ctrl + Alt + I|	光标所在行 或选中部分进行自动代码缩进，有点类似格式化
Ctrl + Alt + T|	对选中的代码弹出环绕选项弹出层 （必备）
Ctrl + Alt + J|	弹出模板选择窗口，将选定的代码加入动态模板中
Ctrl + Alt + H|	调用层次
Ctrl + Alt + T|	鼠标放在代码语句上生成多种环绕代码块
...
Ctrl + Shift + F8|	查看所有断点,在 Debug 模式下，指定断点进入条件(必备)
